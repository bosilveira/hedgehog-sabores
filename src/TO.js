...
export default function ReceitaTO() {
    ...
    <Container maxWidth="md" style={{position: "relative", width: "100%", top: "0px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", paddingLeft: 0, paddingRight: 0}} >
        <Box style={{position: "relative", width: '100%', top:"0px", height: '209px', minWidth: "320px", borderBottom: "2px solid #BE952B"}} >
            <img style={{position: "absolute", minWidth: "320px", width: "100%", height: "209px", objectFit: "cover" }} src={Prato} alt={"Paçoca de Carne de Sol - Tocantins"} />
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: '#D8D2C6', maxWidth: '480px', textAlign: 'left'}}>Corte a carne em pedaços pequenos e leve ao fogo com água para ferver por aproximadamente 15 minutos. Escorra a água. Se a carne estiver muito salgada, ferva novamente.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: '#D8D2C6', maxWidth: '480px', textAlign: 'right'}}>Em uma panela refogue a cebola picada, o alho e o colorau. Junte a carne e deixe fritar até ficar dourada, mexendo sempre. No liquidificador, coloque os pedacinhos de carne e bata no pulsar até desfiar.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: '#D8D2C6', maxWidth: '480px', textAlign: 'left'}}>Leve a carne novamente ao fogo na sobra do óleo que fora refogado. Aos poucos, vá acrescentando a farinha em cuidado para não ficar seca. Coloque o cheiro verde para finalizar.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#33753F', width: '100%', minHeight: '320px', minWidth: "320px", display: 'flex', gap: '24px', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', padding: '48px 0'}} >
            ...
            <Box sx={{backgroundColor: "transparent", textAlign: "center"}}>
                <p>Vinho Branco:</p>
                <Link color="#242424" href="https://www.bancadoramon.com.br/vinho-la-joya-gran-reserva-sauvignon-blanc-750ml">LA JOYA SAUVIGNON BLANC</Link>
            </Box>
            <Box sx={{backgroundColor: "transparent", textAlign: "center"}}>
                <p>Vinho Tinto:</p>
                <Link color="#242424" href="https://www.bancadoramon.com.br/vinho-la-posta-bonarda-750ml">LA POSTA BONARDA</Link>
            </Box>
