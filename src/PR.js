  ...
  export default function ReceitaPR() {
    ...
    <Container maxWidth="md" style={{position: "relative", width: "100%", top: "0px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", paddingLeft: 0, paddingRight: 0}} >
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'left'}}>Cubra o pinhão com água e cozinhe em uma panela de pressão. Depois, descasque e triture em um liquidificador.</Typography>
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'left'}}>Reserve.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Em uma panela, frite o alho e a cebola e refogue a carne moída com um pouco de sal.</Typography>
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Reserve.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'left'}}>Na frigideira, frite o bacon e a calabresa.</Typography>
        </Box>
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'column', gap: '8px'}} >
            ...
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Misture tudo em uma panela, começando pela carne moída, a farofa do pinhão, o bacon e a calabresa. </Typography>
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Mexa bem e deixe aquecer antes de servir.</Typography>
        </Box>
