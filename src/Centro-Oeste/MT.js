    ...
    return (
        <>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Corte a carne em pedaços e tempere com sal, pimenta, vinagre e o alho.
                    Em uma panela espaçosa coloque o óleo e deixe esquentar.
                    Quando o óleo estiver bem quente, coloque a carne.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Assim que a carne estiver frita coloque bastante cebola, ou cortada em rodelas, ou picada.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Quando a cebola estiver fritinha, coloque o arroz e deixe-o fritar por alguns minutos.
                    Não esqueça de mexer. Feito isso, coloque a água fervendo e deixe cozinhar.
                </Typography>
                <Typography variant="body1">
                    Uma boa pedida é servir com uma deliciosa salada.
                </Typography>
            </Box>
