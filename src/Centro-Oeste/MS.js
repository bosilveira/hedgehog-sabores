    ...
    return (
        <>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Tempere a carne com sal, alho e limão.
                    Refogue-a e acrescente pimentão, cebola, tomate, extrato de tomate, ervilha e milho verde.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Deixe a carne fritar e acrescente a água.
                </Typography>
                <Typography variant="body1">
                    Cozinhe a dúzia de ovos.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Frite as batatas palito e as bananas em rodelas.
                    Coloque em um refratário em camadas o arroz, molho da carne, batata e bananas fritas.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Repita as camadas e coloque os ovos por cima.
                </Typography>
            </Box>
