    ...
    return (
        <>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Coloque o pequi no óleo ou gordura fria (se for usar o fruto inteiro não precisa cortar, mas tenha cuidado com o caroço).
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Acrescente alho e cebola e deixe refogar em fogo baixo.
                    Mexa sempre com uma colher de pau para não grudar na panela.
                    De vez em quando, respingue um pouco de água.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Quando o pequi estiver macio e a água tiver secado, acrescente o arroz e deixe fritar um pouco.
                    Junte a água restante e o sal.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Quando o arroz estiver quase no ponto, coloque a pimenta-de-cheiro ou a malagueta a gosto.
                </Typography>
                <Typography variant="body1">
                    No momento em que for servir, polvilhe o arroz com salsa, cebolinha e mais um pouco de pimenta.
                </Typography>
            </Box>
