    ...
    return (
        <>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Bata os ovos e o leite em um refratário e tempere com sal e pimenta-do-reino.
                </Typography>
                <Typography variant="body1">
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Tempere a tilápia com sal, pimenta-do-reino.
                </Typography>
                <Typography variant="body1">
                    Corte em pedaços pequenos de sua preferência.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Passe as tilápias primeiro pela farinha de trigo e empane dos 2 lados.
                </Typography>
                <Typography variant="body1">
                    Passe pela mistura de ovos e leite e depois na farinha de rosca empanando pelos 2 lados.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Frite em óleo bem quente por 3 minutos.
                </Typography>
                <Typography variant="body1">
