        ...
        <>
            ...
            <Box className={"ingredientes sudeste"}>
                ...
                <Typography variant="body1">
                    01 maço de couve com folhas cortadas finas
                </Typography>
                <Typography variant="body1">
                    01 dente de alho
                </Typography>
                ...
                <Typography variant="body1">
                    03 copos de arroz frito
                </Typography>
                <Typography variant="body1">
                    (de preferência feito com banha)
                </Typography>
                <Typography variant="body1">
                    04 linguiças
                </Typography>
                <Typography variant="body1">
                    04 bistecas de porco
                </Typography>
                <Typography variant="body1">
                    Farinha de milho
                </Typography>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    ...
                    Após cozido o feijão, tempere com alho e cebola fritos.
                </Typography>
                <Typography variant="body1">
                    Reserve.
                </Typography>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Corte o bacon em cubos e frite, refogando o alho e a couve nele.
                </Typography>
                <Typography variant="body1">
                    Reserve.
                </Typography>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Frite separadamente os ovos, a linguiça, as bistecas e o torresmo.
                </Typography>
                <Typography variant="body1">
                    Reserve.
                </Typography>
                <Typography variant="body1">
                    Adicione um pouco da farinha de milho ao feijão para fazer o virado.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    No prato, sirva uma porção de arroz com uma porção do virado e adicione linguiça, torresmo, uma bisteca e um ovo.
                </Typography>
            </Box>
