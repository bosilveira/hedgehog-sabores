  ...
  export default function ReceitaRS() {
    ...
    return (
      ...
      display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: '8px', padding: '48px 0'}} >
          ...
          <p>Carne bovina de sua preferência </p>
            <p>(costela, picanha, maminha, etc)</p>
            <p>Sal grosso à vontade</p>
      </Box>
      ...
      display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: '12px', padding: '48px 0'}} >
          ...
          <p>&nbsp;</p>
          <p>Vinho Branco:</p>
          <p>VILLA ANTINORI TOSCANA BRANCO</p>
          <p>&nbsp;</p>
          <p>Vinho Tinto:</p>
          <p>EL ENEMIGO SYRAH-VIOGNIER</p>
          <p>&nbsp;</p>
