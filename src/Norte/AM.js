    ...
    return (
        <>
            ...
            <Box className={"ingredientes norte"}>
                ...
                <Typography variant="body1">
                    03 tomates sem sementes cortados em 4 partes
                </Typography>
                <Typography variant="body1">
                    03 cebolas cortadas igual ao tomate
                </Typography>
                <Typography variant="body1">
                    15 pimentas-de-cheiro sem sementes
                </Typography>
                <Typography variant="body1">
                    e cortadas no meio (se preferir)
                </Typography>
                <Typography variant="body1">
                    01 maço de cheiro verde picado
                </Typography>
                <Typography variant="body1">
                    01 maço de cebolinhas picado
                </Typography>
                <Typography variant="body1">
                    Colorau a gosto
                </Typography>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    No dia anterior, lave bem o peixe com água fria.
                    Coloque-o em um refratário banhando-o com o caldo do limão e sal.
                    Leve à geladeira.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    No momento em que for preparar, passe o peixe apenas uma vez em água corrente para tirar o excesso do limão.
                </Typography>
                <Typography variant="body1">
                    Em uma panela grande coloque o peixe, tomate, cebola, pimenta-de-cheiro e parte do coentro e cebolinha.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Coloque água o suficiente para cobrir o peixe.
                    Acrescente o azeite a gosto, 01 colher de sobremesa de vinagre e o colorau.
                </Typography>
                <Typography variant="body1">
                    Vá salgando aos poucos, pois durante a fervura o sal que está no peixe vai soltando no caldo.
                    Ferva por aproximadamente 20 minutos.
                </Typography>
                <Typography variant="body1">
                    Apague o fogo e coloque o resto do coentro e da cebolinha.
                    Sirva a seguir.
                </Typography>
            </Box>
