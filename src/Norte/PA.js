        ...
        <>
            <Container maxWidth="md" className={"receita"}>
                ...
                <Box className={"preparo-body-right"}>
                    ...
                    <Typography variant="body1">No dia do preparo, corte o pato em pedaços, aqueça uma panela com manteiga e azeite, acrescente 4 dentes de alho amassados, cebola e tomate picados. Refogue bem até que a cebola comece a dourar e adicione os pedaços de pato para selar.</Typography>
                </Box>
                ...
                <Box className={"preparo-body-left"}>
                    ...
                    <Typography variant="body1">Despeje o pato refogado em uma assadeira e leve ao forno, preaquecido, a 200ºC por aproximadamente 1 hora.</Typography>
                    <Typography variant="body1">Enquanto isso, coloque o Tucupi para ferver com sal, 3 dentes de alho e a chicória.</Typography>
                ...
                <Box className={"preparo-body-right"}>
                    ...
                    <Typography variant="body1">Lave o jambu em água fria por alguns minutos. Remova as flores e ferva com água e sal até que tenha amolecido. Escorra a água e coloque o jambu dentro da panela com o tucupi quente. Acrescente a pimenta-de-cheiro levemente amassada.</Typography>
                    <Typography variant="body1">Quando o pato estiver macio, coloque-o dentro da panela com o tucupi e ferva novamente.</Typography>
                </Box>
