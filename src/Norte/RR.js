        ...
        <>
            ...
            <Box className={"ingredientes norte"}>
                ...
                <Typography variant="body1">
                    02 peixes - Tambaqui ou tucunaré
                </Typography>
                <Typography variant="body1">
                    01 litro de leite de coco
                </Typography>
                <Typography variant="body1">
                    01 sachê de molho de tomate
                </Typography>
                <Typography variant="body1">
                    02 cebolas médias
                </Typography>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Corte o peixe em postas, do tamanho que desejar.
                    Tempere com sal e pimenta do reino e deixe reservado.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Em uma panela funda, adicione óleo, cebola, tomate e pimentão.
                    Deixe refogar até a cebola dourar.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Adicione o molho de tomate e o peixe.
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Acrescente o leite de coco e deixe ferver até o peixe ficar macio.
                </Typography>
                <Typography variant="body1">
                    Por fim, coloque os ovos já cozidos e inteiros.
                </Typography>
            </Box>
