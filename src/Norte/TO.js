    ...
    return (
        <>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Corte a carne em pedaços pequenos e leve ao fogo com água para ferver por aproximadamente 15 minutos.
                    Escorra a água.
                    Se a carne estiver muito salgada, ferva novamente.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Em uma panela refogue a cebola picada, o alho e o colorau.
                    Junte a carne e deixe fritar até ficar dourada, mexendo sempre.
                    No liquidificador, coloque os pedacinhos de carne e bata no pulsar até desfiar.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Leve a carne novamente ao fogo na sobra do óleo que fora refogado.
                    Aos poucos, vá acrescentando a farinha em cuidado para não ficar seca.
                    Coloque o cheiro verde para finalizar.
                </Typography>
            </Box>
