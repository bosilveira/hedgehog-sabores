        ...
        <>
            ...
            <Box className={"ingredientes norte"}>
                ...
                <Typography variant="body1">
                    1,5 de gurijuba fresca
                </Typography>
                <Typography variant="body1">
                    800g de camarão sem cabeça (fresco ou salgado)
                </Typography>
                <Typography variant="body1">
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Corte a gurijuba em postas não muito finas.
                    Tempere com suco de limão, alho, sal a gosto e cheiro-verde.
                    Deixe por mais ou menos uma hora neste tempero.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-right"}>
                ...
                <Typography variant="body1">
                    Em uma panela grande, refogue o alho com azeite de dendê (04 colheres de sopa).
                    Coloque uma camada de peixe, outra com cebola e tomate, pimentão (cortados em rodela), cheiro-verde e o camarão.
                </Typography>
            </Box>
            ...
            <Box className={"preparo-body-left"}>
                ...
                <Typography variant="body1">
                    Assim que organizar todos os ingredientes, acrescente o leite de coco e deixe cozinhar por 20 minutos.
                </Typography>
            </Box>
