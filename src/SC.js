...
export default function ReceitaSC() {
  ...
  <Container maxWidth="md" style={{position: "relative", width: "100%", top: "0px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", paddingLeft: 0, paddingRight: 0}} >
      ...
      <Box style={{background: `url(${Bottom}) center top no-repeat`, backgroundSize: 'cover', width: '100%', height: '120px', minWidth: "320px", display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'column'}} >
          ...
          <Typography variant="h2" sx={{backgroundColor: 'transparent', minWidth: "320px", textAlign: 'center', fontFamily: "Cookie", color: 'white', fontSize: '48px', marginTop: '-12px'}}>
              Joelho de Porco
          </Typography>
      </Box>
      ...
      <Box style={{background: `url(${Top}) center top no-repeat`, backgroundSize: 'cover', width: '100%', height: '120px', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}} >
          <Typography variant="h3" sx={{backgroundColor: 'transparent', fontFamily: "Abril Fatface", color: 'white', fontSize: '24px'}}>
              Modo de Preparo
          </Typography>
      </Box>
      ...
      <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
          <Typography variant="body1" sx={{backgroundColor: 'transparent', fontFamily: "Abril Fatface", color: 'white', fontSize: '92px', width: "50%", borderBottom: "1px solid white", textAlign: 'left'}}>
              01.
          </Typography>
          <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'left'}}>Coloque os joelhos em uma panela de pressão, cubra-os de água e cozinhe por aproximadamente 45 minutos ou até as carnes começarem a se soltar dos ossos. Retire da água (reserve) e escorra-os.</Typography>
      </Box>
      ...
      <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'column', gap: '8px'}} >
          <Typography variant="body1" sx={{backgroundColor: 'transparent', fontFamily: "Abril Fatface", color: 'white', fontSize: '92px', width: "50%", borderBottom: "1px solid white", textAlign: 'right'}}>
              02.
          </Typography>
          <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Na sequência, coloque as carnes num refratário e regue a pele com o óleo pré-aquecido bem quente para formar pururuca na casca. Se necessário, repita o processo para que a pele fique crocante.</Typography>
      </Box>
      ...
      <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', gap: '8px'}} >
          ...
          <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'left'}}>Na água em que ferveram os joelhos, cozinhe as batatas descascadas e as salsichas.</Typography>
      </Box>
      ...
      <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'flex-end', flexDirection: 'column', gap: '8px'}} >
          ...
          <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Em uma panela, coloque o chucrute e adicione ½  copo de água e o zimbro. Deixe ferver por 5 minutos.</Typography>
          <Typography variant="body1" style={{margin: "4px 24px", color: 'white', maxWidth: '480px', textAlign: 'right'}}>Para servir, arranje tudo em uma só travessa.</Typography>
      </Box>
