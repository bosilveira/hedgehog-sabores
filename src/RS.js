  ...
  export default function ReceitaRS() {
    ...
    <Container maxWidth="md" style={{position: "relative", width: "100%", top: "0px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", paddingLeft: 0, paddingRight: 0}} >
        ...
        <Box style={{backgroundColor: '#232323', width: '100%', minWidth: "320px", display: 'flex', justifyContent: 'center', alignItems: 'CENTER', flexDirection: 'column', gap: '8px', padding: "24px 0 0 0"}} >
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', textAlign: 'center'}}>Posicione os pedaços de carne num espeto.</Typography>
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', textAlign: 'center'}}>Passe o sal e coloque a uma distância de 25 cm da chama.</Typography>
            <Typography variant="body1" style={{margin: "4px 24px", color: 'white', textAlign: 'center'}}>O ponto tradicional da carne é mal passado, com o exterior apenas chamuscado.</Typography>
        </Box>
